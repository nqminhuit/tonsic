...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { NOTE_NAMES, CHORD_FORMULAS, buildChord, chordName, randomChord, matchChord, buildVoicing, matchExactVoicing };
}

// Also expose on window for any legacy scripts (non-critical)
if (typeof window !== 'undefined') {
  window.Tonsic = { randomChord, matchChord, buildChord, CHORD_FORMULAS, NOTE_NAMES, buildVoicing, matchExactVoicing };
}
