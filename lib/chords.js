...
if (typeof window !== 'undefined') {
  window.Tonsic = { randomChord, matchChord, buildChord, CHORD_FORMULAS, NOTE_NAMES, getChordDegrees, buildVoicing, matchExactVoicing, setEnabledChordTypes, getEnabledChordTypes, getChordInfo };
}
